...
@Component({
    selector: 'OpenSaleBoxModal',
    templateUrl: './open-sale-box.component.html',
    styleUrls: ['./open-sale-box.component.scss']
})

export class OpenSaleBoxComponent implements OnInit {
    @Input() modal: any = "OpenSaleBoxModal"
    @Input() title: string = "Abrir caixa de Vendas"
