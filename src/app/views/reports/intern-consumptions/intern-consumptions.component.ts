...
@Component({
    selector: 'app-intern-consumptions',
    templateUrl: './intern-consumptions.component.html',
    styleUrls: ['./intern-consumptions.component.scss']
})

export class InternConsumptionsComponent implements OnInit {
    ...
    get_reports(){
        ...
        .intern_consumptions_billigs(this.filter.pagination)
        .subscribe(response => {
